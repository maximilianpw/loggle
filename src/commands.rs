...
pub const COMMANDS: &[Command] = &[
    ...
    Command {
        shortcut: "m",
        label: "Show display field",
        description: "Show the selected property as a stable log-row column",
        action: CommandAction::AddDisplayField,
    },
    Command {
        shortcut: "M",
        label: "Display fields",
        description: "Choose observed properties to show as log-row columns",
        action: CommandAction::DisplayFields,
    },
    Command {
        shortcut: "P",
...
pub fn normal_action_for_key(key: KeyEvent) -> Option<CommandAction> {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('m'), _) => Some(CommandAction::AddDisplayField),
        (KeyCode::Char('M'), _) => Some(CommandAction::DisplayFields),
